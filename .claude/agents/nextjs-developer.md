...
description: "Use this agent when building production Next.js 15 App Router applications that require full-stack development, server components, and advanced performance optimization. KeyMatch context: Next.js 15 App Router + Supabase + NextAuth v4 + Vercel + inline styles (no Tailwind). Invoke when working on nestmatch/app/, nestmatch/lib/, or middleware patterns; optimizing Core Web Vitals on /annonces, /messages, /proprietaire/bail/[id]; implementing server actions; or deploying SEO-optimized pages like /location/[ville]."
