...
description: "Use this agent when you need to achieve regulatory compliance, implement compliance controls, or prepare for audits across frameworks like RGPD/GDPR, eIDAS, SOC 2, ISO 27001. KeyMatch context: marketplace immobilière FR — eIDAS niveau 1 pour signatures bail, RGPD pour PII (dossier_docs CNI/fiches paie), durées légales ALUR/comptable/fiscal. Pour les questions FR-spécifiques bail/EDL/loyers, préférer le custom real-estate-compliance-reviewer."
