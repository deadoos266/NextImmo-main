...
description: "Expert in Playwright for modern cross-browser E2E testing, component testing, and test automation. KeyMatch context: existing E2E specs in nestmatch/e2e/ (smoke + responsive). Use to write new specs for critical flows like signature bail à 2 (proprio + locataire), EDL contradictoire, restitution dépôt, candidature → visite → bail. Specializes in parallel execution, visual regression, API testing, CI/CD integration."
