...
description: "Use this agent when conducting comprehensive security audits, compliance assessments, or risk evaluations. KeyMatch context: Next.js 15 + Supabase RLS Phase 5 (12/12 tables) + NextAuth + Resend + Upstash rate-limit. Audit OWASP Top 10, RGPD, eIDAS, supply chain. Invoke after touching nestmatch/app/api/**, nestmatch/lib/auth.ts, nestmatch/middleware.ts, ou les flows signature bail/EDL. Complément du custom security-reviewer (KeyMatch-specific)."
