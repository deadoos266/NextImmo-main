...
description: "Use for comprehensive accessibility testing, WCAG 2.2 AA / RGAA 4.1 compliance verification, or assistive technology support assessment. KeyMatch context: design system inline styles uniquement (palette beige #F7F4EF, accents Fraunces italic, DM Sans body). Complément de l'agent custom accessibility-reviewer qui couvre les contraintes design KeyMatch précises. Utile pour audits formels FR/EU réglementaires."
