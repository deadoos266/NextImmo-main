 ...
 */
// V28 (Paul 2026-04-29) — scoreFoyer V25.3 retiré. User feedback :
// "je suis pas certain du bonus en mode que quand c'est famille ça met +
// en avant le jardin car y a déjà ça dans les trucs d'équipement donc
// peux-tu enlever". Choix produit : préférer le tri-state explicite
// V13 (équipements secondaires) où l'user marque "jardin: indispensable"
// plutôt qu'un auto-bonus paternaliste qui suppose toute famille = jardin.
...
export function calculerScore(annonce: Annonce, profil: Profil): number {
  ...
  // V28 — scoreFoyer V25.3 retiré (user préfère le tri-state V13 explicite).
