      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "24px 16px" : "40px 48px" }}>
        ...
        <Sec t="Caractéristiques">
          ...
          <div>
            ...
            {/* V9.1 — soft warning si DPE F/G choisi. */}
            {(form.dpe === "F" || form.dpe === "G") && (
              <div style={{
                marginTop: 12, background: "#FBF6EA", border: "1px solid #EADFC6",
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: 11.5, color: "#6b5314", margin: "4px 0 0", lineHeight: 1.5 }}>
                    Pensez aux travaux de rénovation énergétique. <a href="https://www.legifrance.gouv.fr/loda/id/LEGISCTA000043959654/" target="_blank" rel="noopener noreferrer" style={{ color: "#a16207", textDecoration: "underline", fontWeight: 700 }}>Loi Climat &amp; Résilience</a>.
                  </p>
                </div>
              </div>
            )}
