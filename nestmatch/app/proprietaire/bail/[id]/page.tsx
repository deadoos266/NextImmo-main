...
export default function BailPage() {
  ...
  async function generer() {
    ...
    // Payload complet réutilisable côté locataire pour régénérer le même PDF.
    ...
    if (locataireEmail) {
      ...
      if (fromEmail) {
        const dateStr = form.dateDebut
          ...
          : ""
        // Payload complet (23 champs) → le locataire peut régénérer le PDF depuis sa messagerie.
