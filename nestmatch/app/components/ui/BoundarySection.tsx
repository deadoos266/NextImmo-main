...
function DefaultFallback({ name, reset }: { name: string; reset: () => void }) {
  return (
    <div style={{ background: "#fef2f2", border: "1.5px solid #fecaca", borderRadius: 16, padding: "18px 20px", color: "#991b1b", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <button
        type="button"
        onClick={reset}
        style={{ background: "white", color: "#991b1b", border: "1.5px solid #fecaca", borderRadius: 999, padding: "6px 14px", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}
      >
        Réessayer
      </button>
    </div>
