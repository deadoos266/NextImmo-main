 ...
 *
 * Remplace l'ancienne pill simple <Link href="/admin">ADMIN</Link> par un
 * trigger dropdown qui donne accès rapide aux 5 pages admin clés :
 *  - Dashboard, Santé, QA Bot, Opérations, Bug reports
 *  - + "Voir tout l'admin" → /admin (qui montre la sidebar complète)
 *
 * Comportement :
 *  - Click pill → ouvre/ferme dropdown
 *  - Esc → ferme
 *  - Click outside → ferme
 *  - Click un item → navigue + ferme
 *
 * Style : palette KeyMatch, animation slide-down 180ms.
 */
