...
export default function FavoriButton({ id }: { id: number }) {
  ...
  return (
    ...
    >
      <svg width="18" height="18" viewBox="0 0 24 24" fill={actif ? "#ef4444" : "none"} stroke={actif ? "#ef4444" : "#6b7280"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
